...
The coffee was roasted by [Ikori Kofi](https://ikorekofi.com/), a roaster from Spain.
<br />
...
<br />
I tried a Rwanda brew, and it really asks for your patience, best prepared with care using a moka method, allowing its crema to fully develop. Take the time to enjoy each layer, every subtle note, and let it surprise you all the way to the very last drop.
<br />
